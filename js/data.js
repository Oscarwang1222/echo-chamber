...
const GAME_DATA = {
  ...
  proHuaweiCards: [
    ...
    { id: 'hw41', source: 'huawei_fans', content: "Mate70 Pro+钛合金版本太帅了！", bias: 'pro_huawei' },
    { id: 'hw42', source: 'huawei_tech', content: "麒麟9100性能大幅提升！", bias: 'pro_huawei' },
    { id: 'hw43', source: 'huawei_official', content: "华为纯血鸿蒙NEXT完全自主！", bias: 'pro_huawei' },
    { id: 'hw44', source: 'huawei_expert', content: "华为盘古大模型全球领先！", bias: 'pro_huawei' },
    { id: 'hw45', source: 'huawei_media', content: "问界M9销量同级第一！", bias: 'pro_huawei' },
    { id: 'hw46', source: 'huawei_fans', content: "华为Mate X6折叠屏技术无敌！", bias: 'pro_huawei' },
    { id: 'hw47', source: 'huawei_tech', content: "华为星闪技术延迟最低！", bias: 'pro_huawei' },
    { id: 'hw48', source: 'huawei_official', content: "华为5.5G商用全球第一！", bias: 'pro_huawei' },
    { id: 'hw49', source: 'huawei_expert', content: "华为MatePad Pro生产力爆表！", bias: 'pro_huawei' },
    { id: 'hw50', source: 'huawei_fans', content: "华为FreeClip耳夹设计太酷！", bias: 'pro_huawei' },
    { id: 'hw51', source: 'huawei_tech', content: "华为MateBook X Pro轻薄本标杆！", bias: 'pro_huawei' },
    { id: 'hw52', source: 'huawei_official', content: "华为云市场份额国内前三！", bias: 'pro_huawei' },
    { id: 'hw53', source: 'huawei_media', content: "华为WATCH GT5健康监测最准！", bias: 'pro_huawei' },
    { id: 'hw54', source: 'huawei_fans', content: "麒麟芯片回归意义重大！", bias: 'pro_huawei' },
    { id: 'hw55', source: 'huawei_tech', content: "华为灵犀通信信号超强！", bias: 'pro_huawei' },
    { id: 'hw56', source: 'huawei_expert', content: "华为XMAGE色彩科学顶级！", bias: 'pro_huawei' },
    { id: 'hw57', source: 'huawei_official', content: "华为HMS生态超苹果！", bias: 'pro_huawei' },
    { id: 'hw58', source: 'huawei_media', content: "华为折叠屏份额全球第一！", bias: 'pro_huawei' },
    { id: 'hw59', source: 'huawei_fans', content: "华为Pura70 Ultra伸缩镜头黑科技！", bias: 'pro_huawei' },
    { id: 'hw60', source: 'huawei_tech', content: "华为Mate60系列全网热销！", bias: 'pro_huawei' },
  ],
  ...
  proMiCards: [
    ...
    { id: 'mi41', source: 'mi_fans', content: "小米15小屏旗舰手感超棒！", bias: 'pro_mi' },
    { id: 'mi42', source: 'mi_tech', content: "骁龙8Elite首发性能最强！", bias: 'pro_mi' },
    { id: 'mi43', source: 'mi_official', content: "小米SU7 Ultra纽北圈速惊人！", bias: 'pro_mi' },
    { id: 'mi44', source: 'mi_expert', content: "小米15 Ultra影像配置天花板！", bias: 'pro_mi' },
    { id: 'mi45', source: 'mi_media', content: "小米汽车工厂产能快速提升！", bias: 'pro_mi' },
    { id: 'mi46', source: 'mi_fans', content: "红米K80 Pro性价比无敌！", bias: 'pro_mi' },
    { id: 'mi47', source: 'mi_tech', content: "小米澎湃OS2流畅度大幅提升！", bias: 'pro_mi' },
    { id: 'mi48', source: 'mi_official', content: "小米MIX Fold4折叠屏更轻薄！", bias: 'pro_mi' },
    { id: 'mi49', source: 'mi_expert', content: "小米手环9健康功能更全面！", bias: 'pro_mi' },
    { id: 'mi50', source: 'mi_media', content: "小米平板6S Pro办公神器！", bias: 'pro_mi' },
    { id: 'mi51', source: 'mi_fans', content: "雷军最后一次演讲太感人了！", bias: 'pro_mi' },
    { id: 'mi52', source: 'mi_tech', content: "小米龙鳞纤维材质太牛了！", bias: 'pro_mi' },
    { id: 'mi53', source: 'mi_official', content: "小米汽车SU7安全测试全G！", bias: 'pro_mi' },
    { id: 'mi54', source: 'mi_expert', content: "小米14T Pro性价比神机！", bias: 'pro_mi' },
    { id: 'mi55', source: 'mi_media', content: "小米之家数量超过华为门店！", bias: 'pro_mi' },
    { id: 'mi56', source: 'mi_fans', content: "红米Turbo4性能小金刚！", bias: 'pro_mi' },
    { id: 'mi57', source: 'mi_tech', content: "小米无线反充功能太实用！", bias: 'pro_mi' },
    { id: 'mi58', source: 'mi_official', content: "Xiaomi HyperOS生态更开放！", bias: 'pro_mi' },
    { id: 'mi59', source: 'mi_expert', content: "小米双模式卫星通信领先！", bias: 'pro_mi' },
    { id: 'mi60', source: 'mi_media', content: "小米13年干翻华为不是梦！", bias: 'pro_mi' },
  ],
